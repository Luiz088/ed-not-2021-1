// Objetos são estrutura que permitem armazenar diversos valores
...
let pessoa = {
    // Os dados são armazzenados no formato
    // propriedade: valor
...
// usar a síntaxe de ponto. É necessário usar a sintaxe de colchetes.
console.log(pessoa['cidade de origem'])
console.log(pessoa.gostos)

// A síntaxe dos colchetes SEMPRE funciona, mesmo se o nome da propriedade
// for uma única palavre sem acento
console.log(pessoa['nome'])
console.log(pessoa['gostos'][1]) // Mostrando só o 2º gosto.

// Outra consequência de síntaxe dos colchetes é a possibilidade de
...
// for..in determina quais as propriedades de um objeto
